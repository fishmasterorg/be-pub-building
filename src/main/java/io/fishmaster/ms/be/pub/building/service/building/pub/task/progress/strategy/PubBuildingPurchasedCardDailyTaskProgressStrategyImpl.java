...
@Component
public class PubBuildingPurchasedCardDailyTaskProgressStrategyImpl extends BasePubBuildingDailyTaskProgressStrategyImpl {

    public PubBuildingPurchasedCardDailyTaskProgressStrategyImpl(
    ...
    public TaskGoalType getType() {
        return TaskGoalType.PURCHASED_CARD;
    }
}
